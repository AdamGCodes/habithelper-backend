...
class Timer(models.Model):
    ...
    exceptions = models.PositiveIntegerField(null=True) #Stretch goal allowing a number of free passes e.g. cutting down on smoking 3 would give 3 tick boxes or three "strikes" on the timer
